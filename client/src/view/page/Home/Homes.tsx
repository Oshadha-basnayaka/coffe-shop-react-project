    ...
    coffee: [
        {
            ...
            description: 'Indulge in warmth and spice with our Chai Coffee at [Your Coffee Shop\'s Name]. A perfect fusion of rich espresso and aromatic chai, it\'s a sip of pure delight. Discover your cozy moment in every cup!',
            price: '$2.89',
        },
        {
            img: OurProductPic2,
...
const Home = () => {
    ...
    const [selectedCategory, setSelectedCategory] = useState<keyof typeof products>('coffee');
        ...
        <>
            ...
            <div id="homePic">
                ...
                <div className="flex gap-10  justify-center pt-[430px] overflow-hidden">
                    <button className=" text-black bg-[#AB8A5A] px-20 py-3 border-2 font-bold  ">

                        <Link to={"/menu"}> View Menu</Link>
                    </button>
                    {/* <button className="text-white border-2 px-5 py-2 ">
            ...
            <div className="bg-gradient-to-r from-[#1B1B1B] to-[#535353] flex justify-center gap-16 items-center ">
                ...
                <div className=" flex-col items-end justify-center flex">
                    ...
                    <br />
                    <br />
                    <p className="text-end text-white max-w-[400px]">At Taste Coffe , each cup is a tale. From
                        sourcing the
            ...
            <div id="CustomerSaysPic">
                ...
                <div className="flex justify-center gap-5 pt-40">
                    ...
                    <div className="bg-[#AB8A5A]  ">
                        <p className="text-2xl max-w-[450px]">Even the all-powerful Pointing has no control about
