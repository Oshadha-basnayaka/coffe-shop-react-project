            ...
            <>
                ...
                <div id="homePic">
                    ...
                    <div className="flex gap-10  justify-center pt-[830px] overflow-hidden" >
                        ...
                        <button className="text-white border-2 px-5 py-2 animate-bounce">
                ...
                <div className="flex justify-center items-center mx-auto bg-gradient-to-r from-[#1B1B1B] to-[#535353] p-10">
                    <div className="flex justify-center items-center bg-neutral-900">
                        <img className="w-[550px]" src={DiscoverOurStory} alt=""/>
                    </div>

                    <div className="flex flex-col justify-center items-start bg-neutral-900 bg-opacity-50 ms-[-100px] p-10 rounded-xl">
                ...
                <div id="CustomerSaysPic">
                    ...
                    <div className="flex justify-center gap-5 pt-40">
                        ...
                        <div className="bg-[#AB8A5A]  ">
                            <p className="text-2xl max-w-[450px]">Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small</p>
                            <h1 className="flex pt-10  justify-end ">Louise Kelly</h1>

                        </div>

                        <div className="bg-[#AB8A5A]   ">
                            <p  className="text-2xl max-w-[450px]">Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small</p>
                            <h1 className="flex pt-10 items-end justify-end">Louise Kelly</h1>
                        </div>
